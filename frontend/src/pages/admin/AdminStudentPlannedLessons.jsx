...
const AdminStudentPlannedLessons = () => {
      ...
      <div>
        ...
        <div className="admin-card p-6 mb-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-slate-800">Planlanmış Dersler</h2>
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <Button data-testid="add-planned-lesson-btn" className="admin-btn">
        ...
        <div className="admin-card p-6">
          {plannedLessons.length === 0 ? (
            <p className="text-slate-600 text-center py-8">Henüz ders planlanmamış</p>
          ) : (
...
export default AdminStudentPlannedLessons;